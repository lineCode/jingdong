...
class httpHandlerTest(unittest.TestCase):
    ...
    def test_get_couponList(self):
        cookie = 'pin=jd_7bc02d0411627; wskey=AAFYy8YMAECfJykNg_8gick7HNp63WknusfVhCO17rx6Be3OkkzbuUVQZMvJI-3eQzePd3MTIh6UN-Cjd1goohV7_GZOX0hV; whwswswws=00'
        login = http_handler.login.Login(self.name, self.pwd, self.uuid, self.user_agent)
        print login.get_couponList(cookie,'9531095279')
